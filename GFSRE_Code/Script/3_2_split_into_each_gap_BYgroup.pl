...
my $cycle = $ARGV[0];
my $dir = $ARGV[1];		# gap folder

my @folders = glob("$dir/SL2.50*");
foreach my $folder(@folders){
	...
	### de novo assembly
	system("perl ./Script/3_2_1_generate_for_cap3.pl");
	system("perl ./Script/3_2_2_get_extend_contig.pl");			# get contig by assembly
	...
	system("perl ./Script/3_2_3_judge_extend_fasta_overlap.pl");
	if(!-e "Overlap.fa"){
		my $n = $cycle + 1;
